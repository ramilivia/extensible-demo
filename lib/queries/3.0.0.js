...
const alternatingPanelWithVariantsQuery = gql`
  query AlternatingPanelWithVariants($locale: Locale!, $id: ID!, $segment: String) {
    alternatingPanelsSection(locales: [$locale, en], where: { id: $id }) {
      id
      alternatingPanelsTitle: title
      description
      assetPosition
...
export {
  ...
  segmentsQuery,
  alternatingPanelWithVariantsQuery,
}
